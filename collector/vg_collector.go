...
func NewVgCollector() *vgCollector {
	return &vgCollector{
...
func (collector *vgCollector) Describe(ch chan<- *prometheus.Desc) {
...
func (collector *vgCollector) Collect(ch chan<- prometheus.Metric) {
